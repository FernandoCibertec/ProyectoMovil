...
public class ObjESTUDIANTE implements Serializable, Parcelable
{
    ...
    public final static Creator<ObjESTUDIANTE> CREATOR = new Creator<ObjESTUDIANTE>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ObjESTUDIANTE createFromParcel(Parcel in) {
            return new ObjESTUDIANTE(in);
        }

        public ObjESTUDIANTE[] newArray(int size) {
            return (new ObjESTUDIANTE[size]);
        }

    }
    ;
    private final static long serialVersionUID = -7885872334223123934L;

    protected ObjESTUDIANTE(Parcel in) {
